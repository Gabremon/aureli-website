...
import { BusinessOwnerDashboard, LocationSelection, Locations, Positions, Profile, OpeningDetail } from "./pages/business";
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/business-owner/openings/:id"
        element={
          <ProtectedRoute allowedRoles={['business']}>
            <OpeningDetail />
          </ProtectedRoute>
